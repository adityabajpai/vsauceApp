...
public class TuteeCrushAdapter extends RecyclerView.Adapter<TuteeCrushAdapter.ViewHolder> {
    ...
    public TuteeCrushAdapter(Context context, List<EggDeliteSet> eggDeliteSets) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        TuteeCrushAdapter.ViewHolder viewHolder = new TuteeCrushAdapter.ViewHolder(v);
        return viewHolder;
    }
