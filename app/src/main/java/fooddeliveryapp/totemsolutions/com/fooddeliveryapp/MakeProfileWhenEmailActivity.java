...
public class MakeProfileWhenEmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_make_profile_when_email);
        ...
        if (firebaseAuth.getCurrentUser() == null) {
            finish();
            startActivity(new Intent(MakeProfileWhenEmailActivity.this, UserRegisterActivity.class));
        }
        ...
        if (imageUri != null) {
            ...
            ref.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    dialog.dismiss();
                    Toast.makeText(MakeProfileWhenEmailActivity.this, "IMAGE UPLOADED", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(MakeProfileWhenEmailActivity.this, AskScheduleActivity.class);
                    ...
                    UserInformation userInformation = new UserInformation(name, gender, dob, address, uploadUrl);
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            dialog.dismiss();
                            Toast.makeText(MakeProfileWhenEmailActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toast.makeText(MakeProfileWhenEmailActivity.this, "Please Select image", Toast.LENGTH_LONG).show();
        }
    }
